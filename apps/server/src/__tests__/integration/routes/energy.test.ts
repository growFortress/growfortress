 ...
 * These mocks MUST be declared here (not just in setup.ts) to ensure
 * they're applied before any transitive imports through testApp.
 */
...
import { generateTestToken } from '../../helpers/testApp.js';
