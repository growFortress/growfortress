...
import { mockPrisma, createMockUser, createMockSession, createMockInventory, createMockProgression, createMockRelicUnlock } from '../../mocks/prisma.js';
...
describe('Auth Routes Integration', () => {
  ...
  describe('POST /v1/auth/register', () => {
    it('should register a new user successfully', async () => {
      ...
      mockPrisma.session.create.mockResolvedValue(createMockSession({ userId: 'new-user-123' }));
